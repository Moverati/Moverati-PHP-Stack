...
/**
 * Zend Feed Writer Renderer for MediaRSS Group Element
 *
 * renderer for mediarss group element items
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Feed_Writer_Extension_MediaRSS_Renderer_Group
extends Zend_Feed_Writer_Extension_RendererAbstract
{
    ...
    {
        $g = $this->_dom->createElement('media:group');

        $this->_renderContents($this->_dom, $g);
        $this->_renderElements($this->_dom, $g);
